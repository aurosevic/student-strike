...
timeline:
  - naslov: Блокада инфо подкаст
    ...
    tekst: |-
      Подкаст, као и пренос целог протеста у Суботици, можете пратити на следећем линку: 

      [https://www.youtube.com/watch?v=tACF1HxeAoc](https://www.youtube.com/watch?v=tACF1HxeAoc)
